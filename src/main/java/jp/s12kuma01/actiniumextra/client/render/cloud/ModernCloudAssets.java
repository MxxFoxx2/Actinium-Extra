package jp.s12kuma01.actiniumextra.client.render.cloud;
...
public final class ModernCloudAssets implements IResourcePack {
    ...
    public static final ResourceLocation CLOUD_TEXTURE =
            new ResourceLocation("actiniumextra", "textures/environment/clouds_1_21_6.png");
    ...
    public static List<IResourcePack> withCloudTexture(List<IResourcePack> packs, boolean enabled) {
        ...
        for (int i = packs.size() - 1; i >= 0; i--) {
            ...
            if (!source.getResourceDomains().contains("actiniumextra")
            ...
            try (InputStream stream = source.getInputStream(CLOUD_TEXTURE)) {
                ...
                ActiniumExtraMod.LOGGER.warn("Could not load the modern cloud texture", exception);
                return packs;
            }
        }
        return packs;
    ...
    public String getPackName() {
        return "Actinium Extra Modern Cloud Texture";
    }
}
