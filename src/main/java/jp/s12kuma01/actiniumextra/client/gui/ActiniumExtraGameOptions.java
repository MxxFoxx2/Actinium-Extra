...
import jp.s12kuma01.actiniumextra.client.particle.ParticleClassRegistry;
...
/**
 * Central store for all Actinium Extra configuration values.
 * <p>
 ...
 */
public class ActiniumExtraGameOptions {
     ...
     */
    public static ActiniumExtraGameOptions load(File file) {
        ActiniumExtraGameOptions options = new ActiniumExtraGameOptions();
        ...
        try {
            ...
            ActiniumExtraMod.LOGGER.error("Could not load config, falling back to defaults!", e);
            ActiniumExtraGameOptions defaults = new ActiniumExtraGameOptions();
    ...
    public enum OverlayCorner {
        ...
        BOTTOM_RIGHT("actiniumextra.option.overlay_corner.bottom_right");
    ...
    public enum VerticalSyncOption {
         ...
         */
        public static VerticalSyncOption getCurrent(ActiniumExtraGameOptions opts) {
         ...
         */
        public static void apply(ActiniumExtraGameOptions opts, VerticalSyncOption value) {
    ...
    public enum ScreenMode {
         ...
         */
        public static ScreenMode getCurrent(ActiniumExtraGameOptions opts) {
         ...
         */
        public static void apply(ActiniumExtraGameOptions opts, ScreenMode mode) {
            var mc = Minecraft.getMinecraft();
