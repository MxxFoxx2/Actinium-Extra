 ...
 * <p>
 * Actinium Extra swaps the plain Fullscreen and VSync toggles for richer three-way controls.
 ...
 * {@link ActiniumExtraOptionSpecs#windowRewrites(boolean)} and expressed here as the set
...
public record StandardRewriteSpec(StandardId standard, OptionSpec option) {
    /**
     * Rows of the renderer's WINDOW group that Actinium Extra knows how to replace.
     */
