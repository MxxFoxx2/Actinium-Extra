package jp.s12kuma01.actiniumextra.renderer;

import jp.s12kuma01.actiniumextra.client.gui.WindowModeSupport;
import jp.s12kuma01.actiniumextra.client.gui.spec.ActiniumExtraOptionSpecs;

/**
 * The renderer-side half of Actinium Extra: one implementation per supported render pipeline.
 * <p>
 ...
 * ({@link ActiniumExtraOptionSpecs}); an adapter below only converts that description into its
...
public interface RendererGlue {
     ...
     * itself.
     * <p>
     * Actinium ships such an option, so contributing Actinium Extra's screen-mode replacement next
     ...
     * {@link ActiniumExtraOptionSpecs#windowRewrites(boolean)} policy call and is the one
    ...
    /**
     * Whether this renderer leaves window management to vanilla, so Actinium Extra's screen-mode
