package jp.s12kuma01.actiniumextra;

import jp.s12kuma01.actiniumextra.renderer.RendererSupport;
...
public class ActiniumExtraMod {
    ...
    public void construct(FMLConstructionEvent event) {
        ...
        if (Loader.isModLoaded("assetmover")) {
            try {
                jp.s12kuma01.actiniumextra.compat.assetmover.AssetMoverCompat
     ...
     * <p>
     * Delegates to {@link jp.s12kuma01.actiniumextra.client.ActiniumExtraClientMod#onClientInit(File)}
    ...
    public void init(FMLInitializationEvent event) {
        if (net.minecraftforge.fml.common.FMLCommonHandler.instance().getEffectiveSide().isClient()) {
            jp.s12kuma01.actiniumextra.client.ActiniumExtraClientMod
