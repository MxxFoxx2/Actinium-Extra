...
/**
 * Chooses the live renderer adapter once per game run and wires Celeritas Extra into it.
 * <p>
    ...
    public static void initialize() {
        ...
        if (detected.isEmpty()) {
            CeleritasExtraMod.LOGGER.error(
                    "No supported renderer found: Celeritas Extra contributes its settings to the video-settings"
        ...
        CeleritasExtraMod.LOGGER.info("Registered Celeritas Extra options with {} {}",
