...
/**
 * The render pipelines Celeritas Extra can attach to.
 * <p>
...
public enum RendererBackend {
    ...
    ACTINIUM("actinium", "Actinium",
            "jp.s12kuma01.celeritasextra.renderer.actinium.ActiniumRendererGlue"),

    /** Celeritas 2.4.0 or newer, the pipeline this addon was originally written against. */
    CELERITAS("celeritas", "Celeritas",
            "jp.s12kuma01.celeritasextra.renderer.celeritas.CeleritasRendererGlue");
    ...
    /**
     * Creates the adapter that binds Celeritas Extra to this backend.
     *
        ...
        try {
            ...
            throw new IllegalStateException(
                    "The installed " + this.displayName + " does not expose the option API "
                            + "Celeritas Extra was built against; check that both mods are current releases",
                    cause);
        }
    }
