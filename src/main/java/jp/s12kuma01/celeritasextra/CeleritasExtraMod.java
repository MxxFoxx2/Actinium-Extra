...
import jp.s12kuma01.celeritasextra.renderer.RendererSupport;
...
/**
 * Main mod entry point for Celeritas Extra, a client-only companion to the Celeritas and Actinium
 * render pipelines.
 * <p>
 * Celeritas Extra layers additional rendering options on top of the renderer and surfaces them
 ...
 * dependency language has no "either of these" form and Celeritas Extra supports both renderers, so
