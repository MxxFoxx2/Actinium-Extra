 ...
 * instantiated reflectively by {@link dev.mxxfoxx.actiniumextra.renderer.RendererBackend} once
...
public final class CeleritasRendererGlue implements RendererGlue {
    ...
    private void onGroupConstruct(OptionGroupConstructionEvent event) {
        ...
        for (int i = 0; i < options.size(); i++) {
            ...
            for (StandardRewriteSpec rewrite : rewrites) {
                ...
                ActiniumExtraMod.LOGGER.debug("Replaced the Celeritas {} option with the Actinium Extra control",
                        target);
            }
        }
    }
    ...
    /**
     * Maps a Celeritas option identifier onto the row Actinium Extra knows how to replace.
     *
