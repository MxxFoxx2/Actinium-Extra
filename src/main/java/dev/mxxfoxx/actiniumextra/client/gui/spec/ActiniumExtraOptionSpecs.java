    ...
    public static PageSpec render() {
        ...
        return new PageSpec(ActiniumExtraOptionPages.RENDER,
                ...
                List.of(
                        ...
                        OptionSpec.bool("actiniumextra.option.render.damage_tilt",
                                (opts, v) -> opts.renderSettings.damageTilt = v,
                                opts -> opts.renderSettings.damageTilt)
                        ),
        ...
        return new PageSpec(ActiniumExtraOptionPages.EXTRA,
                ...
                List.of(
                        GroupSpec.titled(group("overlays"),
                                ...
                                OptionSpec.bool("actiniumextra.option.extra.ram",
                                        (opts, v) -> opts.extraSettings.showRam = v,
                                        opts -> opts.extraSettings.showRam),
                        ...
                        GroupSpec.titled(group("interface"),
                                ...
                                OptionSpec.bool("actiniumextra.option.extra.boss_health",
                                        (opts, v) -> opts.extraSettings.showBossHealth = v,
                                        opts -> opts.extraSettings.showBossHealth),
                                OptionSpec.bool("actiniumextra.option.extra.scoreboard",
                                        (opts, v) -> opts.extraSettings.showScoreboard = v,
                                        opts -> opts.extraSettings.showScoreboard),
                                OptionSpec.bool("actiniumextra.option.extra.potion_icons",
                                        (opts, v) -> opts.extraSettings.showPotionIcons = v,
                                        opts -> opts.extraSettings.showPotionIcons),
